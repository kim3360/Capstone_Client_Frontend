    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.horizontalContainer}>
          <CardTwo
            imageSource={{
              uri: "https://www.shinsegaegroupnewsroom.com/wp-content/uploads/2021/10/%EC%8B%A0%EC%84%B8%EA%B3%84%EC%9D%B8%ED%84%B0%EB%82%B4%EC%85%94%EB%82%A0_%EB%B3%B8%EB%AC%B81.png",
            }}
            title="동양미래대 학식"
            waitingCount={7}
